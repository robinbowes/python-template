...
from synops import __version__
...
project = "synops"
copyright = f"{date.today().year}, Robin Bowes"
author = "Robin Bowes"
...
# LinkCode
code_url = f"https://github.com/robinbowes/python-template/blob/{git_commit}"
...
html_context = {
    # Github options
    "display_github": True,
    "github_user": "robinbowes",
    "github_repo": "python-template",
    "github_version": "main",
